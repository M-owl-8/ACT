// apps/mobile/AppStandalone.tsx
// STANDALONE VERSION - No backend required!
import React, { useEffect, useState } from "react";
import { View, Text, ActivityIndicator, StyleSheet } from "react-native";
import { useTranslation } from "react-i18next";
import AppNavigatorStandalone from "./src/navigation/AppNavigatorStandalone";
import { useAuthStore } from "./src/store/authLocal"; // Using local auth
  ...
  useEffect(() => {
    ...
    const initialize = async () => {
      try {
        ...
        // Then initialize auth (restore session)
    ...
    return (
      <View style={styles.welcomeContainer}>
        ...
        <View style={styles.welcomeContent}>
          ...
          <Text style={styles.subtitle}>Standalone • Offline Mode</Text>
